...
public class User implements java.io.Serializable {
	...
	/** full constructor */
	public User(String userphone, String userpassword, String username, String userlog, String userfun) {
	...
	public String toString() {
		return "User [userid=" + userid + ", userphone=" + userphone + ", userpassword=" + userpassword + ", username="
				+ username + ", userlog=" + userlog + ", userfun=" + userfun + "]";
	}
